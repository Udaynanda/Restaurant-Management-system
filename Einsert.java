	...
	private void initialize() {
		...
		btnInsertRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					pt = cn.main("arg").prepareStatement("insert into employee (employee_id, emp_name, address, ph_no, salary, rating, experience) values(?,?,?,?,?,?,?)");
					...
					pt.setInt(5, Integer.parseInt(textField_4.getText()));
					pt.setInt(6, Integer.parseInt(textField_5.getText()));
					pt.setString(7, textField_6.getText());
					pt.execute();
