...
public class Dtable {
	...
	private void initialize() {
		frame = new JFrame("RMS : Dish Table");
        ...
        model.addColumn("Cooking Time(estimated)");
        model.addColumn("Price");
        model.addColumn("Recipe");
        model.addColumn("Cooking Style");
        try {
            PreparedStatement pstm = cn.main("arg").prepareStatement("SELECT * FROM dish");
