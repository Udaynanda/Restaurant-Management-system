	...
	private void initialize() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PreparedStatement pt;
				try {
					pt = cn.main("arg").prepareStatement("select vendor_name, address, contact from vendors");
					ResultSet rs = pt.executeQuery();
					if(!rs.isBeforeFirst())JOptionPane.showMessageDialog(frame, "No Record available");
					while(rs.next()) {
						textField.setText(rs.getString("vendor_name"));
		...
		btnNewButton_1.setBounds(290, 139, 97, 25);
